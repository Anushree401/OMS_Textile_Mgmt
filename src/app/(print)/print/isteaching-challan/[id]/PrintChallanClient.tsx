      ...
      <div className="max-w-4xl mx-auto bg-white p-8 my-8 print:my-0 print:shadow-none shadow-lg font-sans">
        ...
        <section className="grid grid-cols-2 gap-8 mt-8">
                ...
                <>
                  ...
                  <p>
                    {[
                      ...
                      .filter(Boolean)
                      .join(", ")}
                    {isteachingChallan.ledgers.zip_code
                      ? ` - ${isteachingChallan.ledgers.zip_code}`
                      : ""}
                  </p>
                  <p>M: {isteachingChallan.ledgers.mobile_number}</p>
                  {isteachingChallan.ledgers.email && (
                    <p>E: {isteachingChallan.ledgers.email}</p>
                  )}
                  {isteachingChallan.ledgers.gst_number && (
                    <p>GST: {isteachingChallan.ledgers.gst_number}</p>
                  )}
                </>
              )}
            </div>
          ...
          <div className="text-right">
            ...
            <p className="text-sm">
              <strong>Quality:</strong> {isteachingChallan.quality}
            </p>
          </div>
        </section>
        ...
        <section className="mt-8">
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {(isteachingChallan.batch_number as unknown as string[]).map(
                (bn, index) => (
                    ...
                    <td className="p-2 text-right">
                      {
                        (
                          weaverChallans.find((wc) => wc.batch_number === bn)
                            ?.quality_details as { rate: number }[] | undefined
                        )?.[0]?.rate
                      }{" "}
                      mtr
                    </td>
          ...
          <div className="mt-6">
            ...
            {isteachingChallan.both_selected && (
              <div className="mb-2 p-2 bg-blue-50 rounded text-sm text-blue-700">
                Note: This challan uses the &quot;Both (Top + Bottom)&quot;
                configuration
              </div>
            )}
                ...
                <>
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      {isteachingChallan.both_top_qty !== null &&
                      isteachingChallan.both_top_qty !== undefined
                        ? isteachingChallan.both_top_qty
                        : "N/A"}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      {(() => {
                        ...
                        if (
                          ...
                          isteachingChallan.both_top_qty !== null &&
                          isteachingChallan.both_bottom_qty !== null
                        ) {
                          const totalQty =
                            isteachingChallan.both_top_qty +
                            isteachingChallan.both_bottom_qty;
                          if (totalQty > 0) {
                            return Math.floor(
                              isteachingChallan.quantity / totalQty,
                            );
                          }
                        }
                        return "N/A";
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      {isteachingChallan.both_bottom_qty !== null &&
                      isteachingChallan.both_bottom_qty !== undefined
                        ? isteachingChallan.both_bottom_qty
                        : "N/A"}
                    </span>
                  </div>
                ...
                <>
                  <div className="flex justify-between">
                    <span className="text-gray-600">
                      Top Quantity (Total mtrs):
                    </span>
                    <span className="font-medium">
                      {isteachingChallan.top_qty !== null &&
                      isteachingChallan.top_qty !== undefined
                        ? isteachingChallan.top_qty
                        : isteachingChallan.top_qty === 0
                          ? "0"
                          : "N/A"}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Top 1pc Quantity:</span>
                    <span className="font-medium">
                      {isteachingChallan.top_pcs_qty !== null &&
                      isteachingChallan.top_pcs_qty !== undefined
                        ? isteachingChallan.top_pcs_qty
                        : isteachingChallan.top_pcs_qty === 0
                          ? "0"
                          : "N/A"}
                    </span>
                  </div>
                  ...
                  <div className="flex justify-between">
                    <span className="text-gray-600">
                      Bottom Quantity (Total mtrs):
                    </span>
                    <span className="font-medium">
                      {isteachingChallan.bottom_qty !== null &&
                      isteachingChallan.bottom_qty !== undefined
                        ? isteachingChallan.bottom_qty
                        : isteachingChallan.bottom_qty === 0
                          ? "0"
                          : "N/A"}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Bottom 1pc Quantity:</span>
                    <span className="font-medium">
                      {isteachingChallan.bottom_pcs_qty !== null &&
                      isteachingChallan.bottom_pcs_qty !== undefined
                        ? isteachingChallan.bottom_pcs_qty
                        : isteachingChallan.bottom_pcs_qty === 0
                          ? "0"
                          : "N/A"}
                    </span>
                  </div>
        ...
        {sizeDetails.length > 0 && (
          <section className="mt-8">
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {sizeDetails.map(
                  (size: { size: string; quantity: number }, index: number) => (
                    <tr key={index} className="border-b">
