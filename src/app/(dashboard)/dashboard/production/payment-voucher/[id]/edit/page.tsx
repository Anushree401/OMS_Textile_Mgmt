...
export default async function PaymentVoucherEditPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (error) {
    ...
    return <div className="p-6 text-center">Error loading payment voucher: {error.message}</div>;
  }
