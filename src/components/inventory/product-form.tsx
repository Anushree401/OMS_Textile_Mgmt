...
export function ProductForm({
  ...
  const {
    ...
    defaultValues: {
      ...
      product_status:
        (product?.product_status as "Active" | "Inactive" | "Pipeline") ||
        "Active",
  ...
  const onSubmit = async (data: ProductFormData) => {
    ...
    const totalSizeQty =
      data.product_size?.reduce((sum, s) => sum + s.quantity, 0) || 0;
    ...
    try {
      ...
      const productData: Product = {
        ...
        product_size: data.product_size
          ? JSON.stringify(data.product_size)
          : null,
        created_by: userId,
      };
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Enter comprehensive product information
          </CardDescription>
        </CardHeader>
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setValue(
                    "product_status",
                    value as "Active" | "Inactive" | "Pipeline",
                  )
                }
              >
                <SelectTrigger>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Define different sizes and their quantities
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          {fields.map((field, index) => (
            <div key={field.id} className="flex items-center gap-4">
              <Select
                onValueChange={(value) =>
                  setValue(`product_size.${index}.size`, value)
                }
              ...
              <Input
                type="number"
                {...register(`product_size.${index}.quantity`, {
                  valueAsNumber: true,
                })}
          ...
          {productQty &&
            productSizes &&
            productSizes.reduce((sum, s) => sum + s.quantity, 0) >
              productQty && (
              <p className="text-sm text-red-600">
                Total size quantity exceeds product quantity.
              </p>
            )}
        </CardContent>
      </Card>
