...
const weaverChallanSchema = z.object({
  ...
  total_grey_mtr: z
    .number()
    .min(0.01, "Total grey meter must be greater than 0"),
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <CardContent>
          <div className="bg-blue-50 p-4 rounded-lg">
            <h3 className="font-semibold text-blue-900">
              {bhaktinandanDetails.name}
            </h3>
            <p className="text-blue-700 text-sm">
              {bhaktinandanDetails.address}
            </p>
            <p className="text-blue-700 text-sm">
              Mobile: {bhaktinandanDetails.mobile}
            </p>
            <p className="text-blue-700 text-sm">
              GST: {bhaktinandanDetails.gst}
            </p>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Add quality specifications for the production
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          {fields.map((field, index) => (
            <div key={field.id} className="border p-4 rounded-lg relative">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="space-y-2">
                  <Label htmlFor={`quality_details.${index}.quality_name`}>
                    Select Quality *
                  </Label>
                  <Select
                    onValueChange={(value) =>
                ...
                <div className="space-y-2">
                  <Label htmlFor={`quality_details.${index}.rate`}>
                    Quantity(in mtr) *
                  </Label>
                  <Input
                    type="number"
                ...
                <div className="space-y-2">
                  <Label htmlFor={`quality_details.${index}.grey_mtr`}>
                    Rate per mtr *
                  </Label>
                  <Input
                    type="number"
          ...
          {errors.quality_details && (
            <p className="text-sm text-red-600">
              {errors.quality_details.message}
            </p>
          )}
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Enter production specifications and measurements
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center space-x-2 mb-4">
            <Checkbox
              ...
              onCheckedChange={(checked) =>
                setValue("hasTakaNumber", Boolean(checked))
              }
            />
            <Label
              htmlFor="hasTakaNumber"
          ...
          {errors.taka_details && (
            <p className="text-sm text-red-600">
              {errors.taka_details.message}
            </p>
          )}
          {takaValue > 0 && takaFields.length >= takaValue && (
            <p className="text-sm text-yellow-600 mt-2">
              You have reached the maximum number of entries based on the Taka
              value.
            </p>
          )}
        </CardContent>
