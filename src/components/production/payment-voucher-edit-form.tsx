    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Update payment voucher details</p>
        </div>
        <Button
          variant="outline"
          onClick={() =>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Update the details below to modify this payment voucher
          </CardDescription>
        </CardHeader>
        <CardContent>
                ...
                {!loadingTransactions &&
                  ...
                  availableTransactions.length === 0 && (
                    <p className="text-sm text-gray-500">
                      No{" "}
                      {formData.payment_type === "Credit" ? "debit" : "credit"}{" "}
