...
export function ExpenseContent({
  ...
  const filteredExpenses = expenses.filter((expense) => {
    ...
    const matchesParty =
      !partyFilter ||
      partyFilter === "all" ||
      expense.ledger_id === partyFilter ||
      expense.manual_ledger_id === partyFilter;

    const matchesDate =
      (!startDateFilter ||
        new Date(expense.expense_date) >= new Date(startDateFilter)) &&
      (!endDateFilter ||
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <Button
          onClick={() => router.push("/dashboard/production/expense/create")}
        >
            ...
            <div className="text-2xl font-bold text-purple-600">
              {
                new Set(
                  filteredExpenses.flatMap((e) =>
                    [e.ledger_id, e.manual_ledger_id].filter(Boolean),
                  ),
                ).size
              }
            </div>
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end" className="bg-white">
                        <DropdownMenuItem
                          onClick={() =>
                            router.push(
                              `/dashboard/production/expense/${expense.id}`,
                            )
                          }
                        >
                        ...
                        {canEdit && (
                          <DropdownMenuItem
                            onClick={() =>
                              router.push(
                                `/dashboard/production/expense/${expense.id}/edit`,
                              )
                            }
                          >
                        ...
                        <DropdownMenuItem
                          onClick={() =>
                            router.push(
                              `/dashboard/production/expense/${expense.id}/logs`,
                            )
                          }
                        >
